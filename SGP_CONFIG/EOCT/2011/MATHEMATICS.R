#####################################################################################
###
### 	Scripts associated with 2011 EOCT MATHEMATICS: ALGEBRA_I,   
...
ALGEBRA_I_2011.config <- list(
	ALGEBRA_I.2011 = list( 
		...
		sgp.exact.grade.progression=TRUE,
		sgp.norm.group.preference=2),
	# ALGEBRA_I.2011 = list(  #  Not run originally in 2011.  Not sure if even possible.
...
GENERAL_MATHEMATICS_MS_2011.config <- list(
...
GENERAL_MATHEMATICS_2011.config <- list(
	GENERAL_MATHEMATICS.2011 = list( # Gen Math in 8th and 9th grade, so not really repeaters.
...
SUMMATIVE_HS_MATHEMATICS_2011.config <- list(
	...
	SUMMATIVE_HS_MATHEMATICS.2011 = list(
		...
		sgp.exact.grade.progression=TRUE,
		sgp.norm.group.preference=2),
	# SUMMATIVE_HS_MATHEMATICS.2011 = list(  #  Not run originally in 2011.  Not sure if even possible.
	...
	SUMMATIVE_HS_MATHEMATICS.2011 = list(
		...
		sgp.exact.grade.progression=TRUE,
		sgp.norm.group.preference=0)
) ### END EOCT SUMMATIVE_HS_MATHEMATICS_2011.config
